 ...
 */
function getGitHubCredentialsFromNpmrc(projectRoot) {
...
const withSnowplowAndroid = (config) => {
    ...
    config = (0, config_plugins_1.withDangerousMod)(config, [
        ...
        (modConfig) => {
            ...
            if (!token || !username) {
                console.warn('⚠️  @justwatch/snowplow-react-native-tracker: Could not find GitHub credentials in ~/.npmrc. ' +
                    'Expected:\n' +
            ...
            const gradlePropsPath = path.join(modConfig.modRequest.platformProjectRoot, 'gradle.properties');
            let gradleProps = '';
